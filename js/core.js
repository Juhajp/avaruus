...
renderer.shadowMap.type = THREE.PCFSoftShadowMap;   // pehmeä PCF → ohuiden varjojen (tikkaat, jalakset, antennit) porrastunut reuna pehmenee eikä jitteröi/vilku liikkeessä
